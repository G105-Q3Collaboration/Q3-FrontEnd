...
const Post = ({ username, content, createdAt, deletePost, id, loggedInPerson }) => {
  return (
    <div className="post border rounded p-0 mb-4">
      <div className="pl-3 controls d-flex justify-content-between align-items-center">
        ...
        <span>
         {
           username === loggedInPerson ? <button onClick={() => deletePost(id)}className="btn text-muted"><FaTrash /></button> : null 
          }
         </span>
      </div>
