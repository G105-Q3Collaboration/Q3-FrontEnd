...
const Post = ({ username, content, getPosts, createdAt}) => {
    return (
      <div className="post border rounded p-0 mt-4" onLoad={() => getPosts()}>
        ...
        {/* <img className="card-img-top" src="https://watermarked.cutcaster.com/cutcaster-photo-100067117-Cat-side-profile.jpg" alt="Cat"/> */}
          <div className="reactions p-2">
            <span className="reaction mr-1" onClick={() => this.props.getPosts}><FaPoop /></span>
